...
(cl:defmethod cl:initialize-instance :after ((m <FullPath-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FullPath-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_movements-srv:<FullPath-request> is deprecated: use robotino_movements-srv:FullPath-request instead.")))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <FullPath-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_movements-srv:goal-val is deprecated.  Use robotino_movements-srv:goal instead.")
  (goal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FullPath-request>)))
  ...
  "robotino_movements/FullPathRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FullPath-request)))
  "Returns string type for a service object of type 'FullPath-request"
  "robotino_movements/FullPathRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FullPath-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FullPath-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_movements-srv:<FullPath-response> is deprecated: use robotino_movements-srv:FullPath-response instead.")))

(cl:ensure-generic-function 'path_size-val :lambda-list '(m))
(cl:defmethod path_size-val ((m <FullPath-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_movements-srv:path_size-val is deprecated.  Use robotino_movements-srv:path_size instead.")
  (path_size m))

(cl:ensure-generic-function 'num_turns-val :lambda-list '(m))
(cl:defmethod num_turns-val ((m <FullPath-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_movements-srv:num_turns-val is deprecated.  Use robotino_movements-srv:num_turns instead.")
  (num_turns m))

(cl:ensure-generic-function 'full_path-val :lambda-list '(m))
(cl:defmethod full_path-val ((m <FullPath-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_movements-srv:full_path-val is deprecated.  Use robotino_movements-srv:full_path instead.")
  (full_path m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FullPath-response>)))
  ...
  "robotino_movements/FullPathResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FullPath-response)))
  "Returns string type for a service object of type 'FullPath-response"
  "robotino_movements/FullPathResponse")
