...
(cl:in-package robotino_movements-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <RobotPos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotPos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_movements-msg:<RobotPos> is deprecated: use robotino_movements-msg:RobotPos instead.")))

(cl:ensure-generic-function 'posX-val :lambda-list '(m))
(cl:defmethod posX-val ((m <RobotPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_movements-msg:posX-val is deprecated.  Use robotino_movements-msg:posX instead.")
  (posX m))

(cl:ensure-generic-function 'posY-val :lambda-list '(m))
(cl:defmethod posY-val ((m <RobotPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_movements-msg:posY-val is deprecated.  Use robotino_movements-msg:posY instead.")
  (posY m))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <RobotPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_movements-msg:phi-val is deprecated.  Use robotino_movements-msg:phi instead.")
  (phi m))
