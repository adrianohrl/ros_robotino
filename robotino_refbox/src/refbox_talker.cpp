...
int main(int argc, char **argv)
{
    ...
    posY = 0;
    posTheta = 0;
    machine_name_ = "M13"; // Máquina que vai reportar
    machine_type_ = "T5"; // Tipo da máquina que vai reportar
...
//	timer_->async_wait(handle_timer);
    ...
    */
    ...
    ros::Publisher position_pub = n.advertise<std_msgs::String>("position", 100);
